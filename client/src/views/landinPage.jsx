...
export const LandinPage = () => {
  return (
    <Container style={{marginTop: "150px"}}>
      ...
      <img style={{width: "100%", marginTop: "20px"}} src="https://www.telemundo.com/sites/nbcutelemundo/files/images/gallery/2017/07/05/perro-de-raza-samoyedo-sobre-el-cesped-3.jpg"/>
    </Container>
  );
};